...
let reduce atom_list (BRule ((lhs_local_indegs, lhs_atoms), (rhs_local_indegs, rhs_atoms), (redirs, free_indeg_diffs))) =
  ...
  Pushout.push_atoms rhs_local_indegs env.free_addr2indeg env.free2addr rhs_atoms @ atom_list
